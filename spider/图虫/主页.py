...
if __name__ == "__main__":
    url = 'https://gewala81.tuchong.com/95199470/'
    item = Tuchong()
    item.main('favorites', url, 2)
    # 测试第2页跟第1页一模一样
